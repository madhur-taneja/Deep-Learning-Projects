...
### Note: This file is made mostly from the code provided by Udacity in the "Project: Teach a Quadcopter How to Fly" section ###
#1 For ReplayBuffer
import random
from collections import namedtuple, deque

#2 For DDPG: Actor (Policy) Model
from keras import layers, models, optimizers
from keras import backend as K

#3 For DDPG: Critic (Value) Model
#4 DDPG: Agent
